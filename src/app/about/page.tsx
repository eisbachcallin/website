  ...
  return (
    <div className='mx-auto w-full px-2 py-12'>
      <div className='flex flex-col items-start justify-center gap-6 xl:mx-auto xl:grid xl:max-w-max xl:grid-cols-2 '>
        <div className='xl:grid-col-1 mx-auto w-full max-w-max object-cover sm:py-16 sm:text-8xl xl:sticky xl:top-0 xl:max-w-none'>
          <Image
            priority
            width={800}
            height={500}
        ...
        <div className='xl:max-w-1/2 xl:grid-col-1 max-w-max space-y-8 xl:max-w-none xl:py-16'>
          <div className='space-y-8 font-sans sm:max-w-[60ch] xl:max-w-[80ch] xl:space-y-16'>
            <section className='text-2xl sm:text-3xl xl:text-5xl'>
              ...
              <h1>
                ...
                dedication and love of all of our supporters. Hugs and kisses
            ...
            <section className='text-2xl sm:text-3xl xl:text-5xl'>
              ...
              <p>
                ...
                channels! Feel free to give most of our recordings a listen too
                on{' '}
                <Link
                  className='text-pink-500 hover:text-gray-900'
                  target='_blank'
