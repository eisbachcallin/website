  ...
  artists={[
    {
      ...
      name: 'Stunts',
      label: 'Vandal Records',
      href: 'https://soundcloud.com/stuntmandnb',
    },
    { name: 'Miso' },
    { name: 'Noise Colors' },
    { name: 'Turdbaby' },
...
<RenderLinks
  links={[
    ...
    { title: 'Stunts on Soundcloud', href: 'https://soundcloud.com/stuntmandnb' },
    { title: 'Stunts on Mixcloud', href: 'https://www.mixcloud.com/StuntsDNB/' },
    {
